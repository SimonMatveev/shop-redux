...
const Profile: FC = () => {
  ...
  const [updateUser, { error: serverError, isSuccess: isSubmitSuccess }] =
    useUpdateUserMutation();
  ...
  return (
    <section className='profile'>
      <Container newClass='profile__container'>
        ...
        <form className='profile__form'>
          ...
          {isEditing && (
            <fieldset className='profile__fieldset'>
              ...
              />
              {errors.password && (
                <p className='profile__error profile__error_second'>{errors.password}</p>
              )}
              <input
                className='profile__input'
                type='password'
        ...
        <button type='button' className='profile__exit' onClick={handleSignOut}>
          Выйти из аккаунта
        </button>
      </Container>
    </section>
