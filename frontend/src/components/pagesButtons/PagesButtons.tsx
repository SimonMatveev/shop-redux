...
const PagesButtons: FC = () => {
  ...
  return (
    <ul className='page-btns'>
      {currentPage - 3 > 0 && (
        <li className='page-btns__item' onClick={handleFirstPageClick}>
          &#8810;
        </li>
      )}
      {currentPage - 2 > 0 && (
        <li className='page-btns__item' onClick={handlePageClick}>
          {currentPage - 2}
        </li>
      )}
      {currentPage - 1 > 0 && (
      ...
      {currentPage + 1 <= buttonsNumber && (
        <li className='page-btns__item' onClick={handlePageClick}>
          {currentPage + 1}
        </li>
      )}
      {currentPage + 2 <= buttonsNumber && (
        <li className='page-btns__item' onClick={handlePageClick}>
          {currentPage + 2}
        </li>
      )}
      {currentPage + 3 <= buttonsNumber && (
        <li className='page-btns__item' onClick={handleLastPageClick}>
          &#8811;
        </li>
      )}
    </ul>
